                            ...
                            <div class="shop-details-nav-wrap">
                                <div class="shop-details-nav">
                                    <div class="shop-nav-item">
                                        <img src="img/product/sd_bottom01.jpg" alt="">
                                    </div>
                                    <div class="shop-nav-item">
                                        <img src="img/product/sd_bottom02.jpg" alt="">
                                    </div>
                                    <div class="shop-nav-item">
                                        <img src="img/product/sd_bottom03.jpg" alt="">
                                    </div>
                                    <div class="shop-nav-item">
                                        <img src="img/product/sd_bottom04.jpg" alt="">
                                    </div>
                                    <div class="shop-nav-item">
                                        <img src="img/product/sd_bottom03.jpg" alt="">
                                    </div>
                            ...
                            <div class="shop-details-img-wrap">
                                <div class="shop-details-active">
                                    <div class="shop-details-img">
                                        <a href="img/product/shop_details_img01.jpg" class="popup-image"><img src="img/product/shop_details_img01.jpg" alt=""></a>
                                    </div>
                                    <div class="shop-details-img">
                                        <a href="img/product/shop_details_img01.jpg" class="popup-image"><img src="img/product/shop_details_img01.jpg" alt=""></a>
                                    </div>
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="shop-details-content">
                                ...
                                <div class="perched-info">
                                    ...
                                    <a data-toggle="modal" data-target="#chktmodal" class="btn add-card-btn">ADD TO CART</a>
                            ...
                            <div class="product-desc-wrap mb-100">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="looks" role="tabpanel" aria-labelledby="looks-tab">
                                        <div class="product-desc-content">
                                            <h4 class="title">Product looks</h4>
                                            <div class="row">
                                                <div class="col-xl-3 col-md-4">
                                                    <div class="product-desc-img">
                                                        <img src="img/product/desc_img.jpg" alt="">
                                                ...
                                                <div class="col-xl-9 col-md-8">
                                                    <h5 class="small-title">The Christina Fashion Looks</h5>
                                                    <p>Cramond Leopard & Pythong Print Anorak Jacket In Beige but also the leap into electronic typesetting, remaining Lorem
                                                    Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy
                                                    text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                                    <ul class="product-desc-list">
                                    ...
                                    <div class="tab-pane fade" id="review" role="tabpanel" aria-labelledby="review-tab">
                                        <div class="product-desc-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-9 col-md-8">
                                                    <h5 class="small-title">The Christina Fashion Review</h5>
                                                    <p>Cramond Leopard & Pythong Print Anorak Jacket In Beige but also the leap into electronic typesetting, remaining Lorem
                                                    Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy
                                                    text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                                    <ul class="product-desc-list">
                                    ...
                                    <div class="tab-pane fade" id="qa" role="tabpanel" aria-labelledby="qa-tab">
                                        <div class="product-desc-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-9 col-md-8">
                                                    <h5 class="small-title">The Christina Fashion Question</h5>
                                                    <p>Cramond Leopard & Pythong Print Anorak Jacket In Beige but also the leap into electronic typesetting, remaining Lorem
                                                    Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy
                                                    text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                                    <ul class="product-desc-list">
