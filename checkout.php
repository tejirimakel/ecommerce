            ...
            <section class="checkout-area pt-100 pb-100">
                          <div class="container">
                            <div class="row justify-content-center">
                              <div class="col-lg-8">
                                <div class="accordion">
                                 <button class="accordio"><i class="bi bi-cart4"></i>&nbsp;Check Out Type</button>
                                  <div class="panel">
                                    <div class="card-body" required>
                                        <input id="personal" class="btn-check rinput" type="radio" name="options1" autocomplete="off">
                                        <label class="btn btn-dark px-3 py-3 my-1 sbtn" for="personal">Personal</label>
                                        <span class="ortext">OR</span>
                                        <input id="business" class="btn-check rinput" type="radio" name="options1" autocomplete="off">
                                        <label class="btn btn-dark px-3 py-3 my-1 sbtn" for="business">Business</label>
                                      </div>
                                  </div>

                                  <button class="accordio"><i class="bi bi-shop"></i>&nbsp;Select Business</button>
                                  <div class="panel">
                                      <div class="card-body">
                                  ...
                                  <button class="accordio"><i class="bi bi-ticket-perferated"></i>&nbsp;Apply Coupon Code</button>
                                  <div class="panel">
                                    <div class="card-body">
                                      <div class="input-group mb-3">
                                        <input type="text" class="form-control" placeholder="Enter Code" aria-label="coupon" aria-describedby="couponcode">
                                  ...
                                  <button class="accordio"><i class="bi bi-credit-card"></i>&nbsp;Pay With Ovaboss Wallet</button>
                                  <div class="panel">
                                    <div class="card-body">
                                      <div class="alert alert-info" role="alert">
                                      Kindly Select from any one of your Ovaboss Wallets that will be debited your total order value.
                                      </div>
                                    </div>
                                  </div>

                                  <button class="accordio"><i class="bi bi-person-lines-fill"></i>&nbsp;Billing Information</button>
                                  <div class="panel">
                                    <div class="card-body">
