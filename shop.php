                                            ...
                                            <ul>
                                                <li>
                                                    <div class="sidebar-product-thumb">
                                                        <a href="shop-details.php"><img src="img/product/sidebar_product01.jpg" alt=""></a>
                                                    </div>
                                                    <div class="sidebar-product-content">
                                                        ...
                                                        <h5><a href="shop-details.php">Slim Fit Cotton</a></h5>
                                                        <span>$ 39.00</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="sidebar-product-thumb">
                                                        <a href="shop-details.php"><img src="img/product/sidebar_product02.jpg" alt=""></a>
                                                    </div>
                                                    <div class="sidebar-product-content">
                                                        <div class="rating">
                                                            <i class="fas fa-star"></i>
                                                ...
                                                <li>
                                                    <div class="sidebar-product-thumb">
                                                        <a href="shop-details.php"><img src="img/product/sidebar_product03.jpg" alt=""></a>
                                                    </div>
                                                    <div class="sidebar-product-content">
                                                        <div class="rating">
                                                            <i class="fas fa-star"></i>
                            ...
                            <div class="row">
                                    ...
                                    <div class="exclusive-item exclusive-item-three text-center mb-50">
                                        <div class="exclusive-item-thumb">
                                            <a href="shop-details.php">
                                                <img src="img/product/t_exclusive_product01.jpg" alt="">
                                        ...
                                        <div class="exclusive-item-content">
                                            <h5><a href="shop-details.php">Fashion Tops Juniors</a></h5>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                                    <div class="exclusive-item exclusive-item-three text-center mb-50">
                                        <div class="exclusive-item-thumb">
                                            <a href="shop-details.php">
                                                <img src="img/product/t_exclusive_product02.jpg" alt="">
                                                <img class="overlay-product-thumb" src="img/product/td_product_img02.jpg" alt="">
                                            </a>
                                            <ul class="action">
                                                <li><a href="#"><i class="flaticon-shuffle-1"></i></a></li>
                                                <li><a href="#"><i class="flaticon-supermarket"></i></a></li>
                                    ...
                                    <div class="exclusive-item exclusive-item-three text-center mb-50">
                                        <div class="exclusive-item-thumb">
                                            <a href="shop-details.php">
                                                ...
                                                <img class="overlay-product-thumb" src="img/product/t_exclusive_product03.jpg" alt="">
                                            </a>
                                            <ul class="action">
                                                <li><a href="#"><i class="flaticon-shuffle-1"></i></a></li>
                                                <li><a href="#"><i class="flaticon-supermarket"></i></a></li>
                                        ...
                                        <div class="exclusive-item-content">
                                            <h5><a href="shop-details.php">Men Casual Blazer</a></h5>
                                            <div class="exclusive--item--price">
                                                <del class="old-price">$69.00</del>
                                                <span class="new-price">$58.00</span>
                                            </div>
